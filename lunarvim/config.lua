...
-- Makefile
lvim.keys.normal_mode[";m"] = ":execute 'make!' | execute 'redraw!'<CR>"

-- Make commit
lvim.keys.normal_mode[";c"]='!make commit m=""<left>'

-- Make update
lvim.keys.normal_mode[";u"]=':!make up<CR>'

-- Make lastdiff
lvim.keys.normal_mode[";d"]=':!make lastdiff<CR>'

-- Make lastdiff2
lvim.keys.normal_mode[";dd"]='!make lastdiff2<CR>'

-- Update origin repository
lvim.keys.normal_mode[";o"]=':!xdg-open<Space>'

-- Make status
lvim.keys.normal_mode[";s"]=':!make status<CR>'

-- Make view
lvim.keys.normal_mode[";v"]=':silent execute "!make view" | execute "redraw!"<CR>'

-- Redraw window
lvim.keys.normal_mode[";r"]=':execute "redraw!"<CR>'
